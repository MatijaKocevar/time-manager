...
-- Recreate the materialized view with weekend filtering for request hour types
...
request_hour_types AS (
    ...
    WHERE status = 'APPROVED'
        ...
        AND EXTRACT(DOW FROM date_in_range) NOT IN (0, 6)  -- Exclude weekends (Sunday=0, Saturday=6)
